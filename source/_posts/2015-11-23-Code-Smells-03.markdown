...
Over the course of the last three articles I presented you a good chunk of the most important / most common code smell scenarios you will ever so often bump into during your object oriented programming career. I feel like this was a good introduction for newbies to this topic and I hope the code examples were verbose enough to follow the thread. Once you have figured out these couple of principles for designing quality code you’ll pick up new smells and their refactorings in no time. If you have made it so far and feel you didn’t loose the big picture I think you’re ready to appraoch boss level OOP status. 
