...
[RIF6](https://rif6.com/) only highlights ...
...
The site for the [SpeedX Leopard](https://speedx.com/smartbike/product/en/leopard/)
...
Funny that [Bootstrap](http://getbootstrap.com/), a popular Open Source project is using purple in a total different context very successfully. I guess Open Source projects have more wiggle room and follow different rules sometimes. Awesome!
...
use one color, slowly put in your color.one dominant color and find one supporting color at most
you can also add neutral colors for support. This makes the dominant color to pop out more strongly. Like with the example with Monet on top.
