...
Shows list of prerequisites for all tasks. Here we use again the `solve_bonnie_situation` task. Omiting output for other tasks, this would be its singled out output:
