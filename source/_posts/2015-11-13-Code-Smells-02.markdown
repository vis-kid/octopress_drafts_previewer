...
class Refund
  ...
  def process(operation)
    transaction_id = PaymentGem.find_transaction(operation.client_id)
    PaymentGem.refund(transaction_id, STANDARD_AMOUNT)
  end
end 
...
class ContractorPayout
  ...
  def process(operation)
    spectre_agent_id = PaymentGem.find(operation.spectre_agent_id)
